...
public class CommentPattern implements IExpressionPattern<Cell> {
    private Pattern m_pattern = Pattern.compile("\\{comment\\}");
 ...
 * jp.co.shin_gi.javadoc.excel.CommentPattern Java Class Version: 7 (51.0) JD-Core Version: 0.7.0.1
 */