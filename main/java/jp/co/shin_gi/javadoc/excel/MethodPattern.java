...
public class MethodPattern implements IExpressionPattern<Cell> {
    private Pattern m_pattern = Pattern.compile("\\{method\\}");
 ...
 * jp.co.shin_gi.javadoc.excel.MethodPattern Java Class Version: 7 (51.0) JD-Core Version: 0.7.0.1
 */